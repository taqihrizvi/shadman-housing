...
const Login = () => {
  ...
  // Force LTR layout on login page
  useEffect(() => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-primary/5 via-background to-accent/5 p-4" dir="ltr" lang="en">
